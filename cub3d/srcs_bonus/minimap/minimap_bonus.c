...
/*   Updated: 2025/07/18 15:06:07 by mosokina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_minimap(t_cub3d *cub3d)
{
	...
	while (map_y < cub3d->map.height)
	{
		...
		while (cub3d->map.grid[map_y][map_x])
		{
			...
			else if (cub3d->map.grid[map_y][map_x] == 'D')
				draw_minimap_tile(cub3d, map_x * MINIMAP_TILE_SIZE,
					map_y * MINIMAP_TILE_SIZE, MINIMAP_DOORS_COLOUR);
			map_x ++;
		}
		map_y ++;
	}
	if (can_walk(cub3d, cub3d->player.pos.x, cub3d->player.pos.y))
